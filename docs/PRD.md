...
|--------|---------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| **0**  | `chore: bootstrap Spring Boot 3.2 project`                          | pom.xml, CI.yml, docker-compose.yml, .gitignore,application.yml, empty V001__init.sql, main class | Build must be green before any feature              |
...
| **7**  | `db: add Flyway migration V001__init.sql`                             | All tables, indexes, FK constraints, enum check constraints                                     | Schema fixed before writing service code            |
